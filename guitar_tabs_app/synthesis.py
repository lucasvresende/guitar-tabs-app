"""Audio synthesis routines for guitar tab notes."""
...
def synthesize_note(
    ...
    """Synthesize a single note with the configured synthesis algorithm.

    Args:
        config: Tab and synthesis configuration.
        frequency: Note frequency in hertz.
        duration: Note duration in seconds.

    Returns:
        Synthesized mono audio samples.

    Raises:
        ValueError: If the configured synthesis algorithm is unsupported.
...
def synthesize_notes(
    ...
    """Synthesize a full tab from a validated notes dataframe.

    Args:
        notes_df: Validated notes dataframe.
        config: Tab and synthesis configuration.

    Returns:
        Mixed mono audio samples for the full tab.
